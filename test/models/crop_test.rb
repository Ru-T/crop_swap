...
class CropTest < ActiveSupport::TestCase
  ...
  test "reject all trades" do
    u1 = User.create!(id: 1, email: "grower@mail.com")
    u2 = User.create!(id: 2, email: "consumer1@mail.com")
    u3 = User.create!(id: 3, email: "consumer2@mail.com")
